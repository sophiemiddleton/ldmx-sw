...
class WabSigCompare:
    ...
    def __init__(self, fn1, ofn, tag):
        ...
        #self.targetSimHits1 = ROOT.std.vector('ldmx::SimTrackerHit')();
        ...
        #self.tin1.SetBranchAddress("TargetSimHits_wab",  ROOT.AddressOf( self.targetSimHits1 ));
        self.histograms = {};
        
        #SimParts:
        self.histograms["simpart_energy_wab"]= ROOT.TH1F("Total Event E SimParts_wab",";  Total Event Energy [MeV]; Weighted N", 400, 0,4000);
...
def main(options,args) : 
    ...
    histoE1 = [];
    tags = ["SimParticle", "WAB Cal Sum", "WAB, FF3 HCAL RecHits", "WAB, FF3 ECAL RecHits"];
    histoE1.append(sc.histograms["simpart_energy_wab"]);
    histoE1.append(sc.histograms["simhit_totE_wabECALHCAL"]);
    histoE1.append(sc.histograms["simhit_totE_wabHCAL"]);
    histoE1.append(sc.histograms["simhit_totE_wabECAL"]);
