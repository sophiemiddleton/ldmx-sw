...
class WabAnalysis:
    ...
    def __init__(self, fn, ofn, tag):
        ...
        self.histograms["hit_x"]= ROOT.TH1F("hit_x","; hit x (mm); N", 400, -2000, 2000);
        self.histograms["hit_y"] = ROOT.TH1F("hit_y","; hit y (mm); N", 400, -2000, 2000);
        self.histograms["hit_z"] = ROOT.TH1F("hit_z","; hit z (mm); N", 400, 0, 4000);
